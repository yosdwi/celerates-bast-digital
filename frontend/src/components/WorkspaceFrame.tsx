...
interface Props {
  ...
  active: "command-center" | "talents" | "actions" | "bast" | "delivery";
    ...
    <div className="app-shell">
      ...
      <main className="main-area">
        <header className="topbar">
          ...
          <div className={`global-search ${searchOpen ? "open" : ""}`}><button className="search-toggle" type="button" aria-label="Search talents" onClick={() => setSearchOpen((value) => !value)}><SearchIcon /></button><input value={search} onChange={(event) => onSearch(event.target.value)} placeholder="Search talents, NRP, or team" aria-label="Search talents" /></div>
