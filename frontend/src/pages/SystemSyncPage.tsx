  ...
  useEffect(() => {
    ...
    async function poll() {
      try {
        ...
        if (!cancelled) setWhatsapp({ connection: "unavailable", me: "", qr_data_url: null });
      }
    }
    void poll();
